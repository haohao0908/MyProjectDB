...
-- ----------------------------
-- Sequence structure for hint_hint_serno_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."hint_hint_serno_seq";
CREATE SEQUENCE "public"."hint_hint_serno_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 2147483647
START 1
...
CREATE TABLE "public"."hint" (
  "hint_serno" int4 NOT NULL DEFAULT nextval('hint_hint_serno_seq'::regclass),
  "project_id" varchar(255) COLLATE "pg_catalog"."default",
  "hint_content" varchar(255) COLLATE "pg_catalog"."default",
  "hint_startdate" timestamp(6),
  "hint_enddate" timestamp(6)
)
;
...
-- Records of hint
-- ----------------------------
INSERT INTO "public"."hint" VALUES (1, NULL, '提醒一', '2019-05-25 17:18:15', '2019-05-25 17:18:15');
INSERT INTO "public"."hint" VALUES (2, NULL, '提醒二', '2019-06-11 16:18:15', '2019-05-25 17:18:15');
INSERT INTO "public"."hint" VALUES (3, NULL, '提醒三', '2019-03-12 15:18:15', '2019-05-25 17:18:15');
INSERT INTO "public"."hint" VALUES (4, NULL, '提醒四', '2019-01-13 14:18:15', '2019-05-25 17:18:15');
INSERT INTO "public"."hint" VALUES (5, NULL, '提醒五', '2019-03-23 13:18:15', '2019-05-25 17:18:15');
INSERT INTO "public"."hint" VALUES (6, NULL, '提醒六', '2019-06-23 12:18:15', '2019-05-25 17:18:15');
INSERT INTO "public"."hint" VALUES (7, NULL, '提醒七', '2019-07-11 11:18:15', '2019-05-25 17:18:15');
INSERT INTO "public"."hint" VALUES (8, NULL, '提醒八', '2019-05-12 10:18:15', '2019-05-25 17:18:15');
INSERT INTO "public"."hint" VALUES (9, NULL, '提醒九', '2019-07-24 19:18:15', '2019-05-25 17:18:15');
INSERT INTO "public"."hint" VALUES (10, NULL, '提醒十', '2019-01-13 18:18:15', '2019-05-25 17:18:15');
...
-- Records of list
-- ----------------------------
INSERT INTO "public"."list" VALUES (1, '列表一', 't');
INSERT INTO "public"."list" VALUES (2, '列表二', 't');
INSERT INTO "public"."list" VALUES (3, '列表三', 'f');
INSERT INTO "public"."list" VALUES (4, '列表四', 't');
INSERT INTO "public"."list" VALUES (5, '列表五', 't');
INSERT INTO "public"."list" VALUES (6, '列表六', 'f');
INSERT INTO "public"."list" VALUES (7, '列表七', 't');
INSERT INTO "public"."list" VALUES (8, '列表八', 't');
INSERT INTO "public"."list" VALUES (9, '列表九', 'f');
INSERT INTO "public"."list" VALUES (10, '列表十', 'f');
...
-- Records of project
-- ----------------------------
INSERT INTO "public"."project" VALUES ('A001', 1, '001A', '專案一', '2019-01-26 15:12:17', '2019-02-05 18:47:17', 'f');
INSERT INTO "public"."project" VALUES ('B001', 2, '001A', '專案二', '2019-02-26 18:41:17', '2019-06-07 19:46:17', 't');
INSERT INTO "public"."project" VALUES ('C001', 3, '001A', '專案三', '2019-03-26 19:35:17', '2019-07-08 20:45:17', 'f');
INSERT INTO "public"."project" VALUES ('D001', 4, '001A', '專案四', '2019-04-26 21:18:17', '2019-08-09 07:44:17', 'f');
INSERT INTO "public"."project" VALUES ('E001', 5, '001A', '專案五', '2019-01-22 08:25:17', '2019-09-10 08:43:17', 'f');
INSERT INTO "public"."project" VALUES ('F001', 6, '001A', '專案六', '2019-01-28 19:55:17', '2019-10-11 10:42:17', 't');
INSERT INTO "public"."project" VALUES ('G001', 7, '001A', '專案七', '2019-01-29 15:15:17', '2019-11-12 15:41:17', 'f');
INSERT INTO "public"."project" VALUES ('H001', 8, '001A', '專案八', '2019-01-30 13:12:17', '2019-12-13 16:40:17', 't');
INSERT INTO "public"."project" VALUES ('I001', 9, '001A', '專案九', '2019-02-15 15:48:17', '2019-08-14 17:39:17', 'f');
INSERT INTO "public"."project" VALUES ('J001', 10, '001A', '專案十', '2019-03-21 17:38:17', '2019-07-15 18:38:17', 'f');
...
-- Records of work
-- ----------------------------
INSERT INTO "public"."work" VALUES (1, '工作一', '這是工作一', '2019-05-25 17:18:15', '@工作', 'zip檔案', '王曉明', '張大陸', 't');
INSERT INTO "public"."work" VALUES (2, '工作二', '這是工作二', '2019-05-25 17:18:15', '@工作', 'zip檔案', '測豐碩', '張辜陸', 'f');
INSERT INTO "public"."work" VALUES (3, '工作三', '這是工作三', '2019-05-25 17:18:15', '@工作', 'zip檔案', '一條先', '德先', 'f');
INSERT INTO "public"."work" VALUES (4, '工作四', '這是工作四', '2019-05-25 17:18:15', '@工作', 'zip檔案', '餔普忒', '特踢', 't');
INSERT INTO "public"."work" VALUES (5, '工作五', '這是工作五', '2019-05-25 17:18:15', '@工作', 'zip檔案', '謀辜', '估三大', 'f');
INSERT INTO "public"."work" VALUES (6, '工作六', '這是工作六', '2019-05-25 17:18:15', '@工作', 'zip檔案', '特蘇噴', '章三大', 't');
INSERT INTO "public"."work" VALUES (7, '工作七', '這是工作七', '2019-05-25 17:18:15', '@工作', 'zip檔案', '辜三是', '一二心', 't');
INSERT INTO "public"."work" VALUES (8, '工作八', '這是工作八', '2019-05-25 17:18:15', '@工作', 'zip檔案', '陳世強', '揚威祥', 'f');
INSERT INTO "public"."work" VALUES (9, '工作九', '這是工作九', '2019-05-25 17:18:15', '@工作', 'zip檔案', '章德馨', '斯紅葉', 'f');
INSERT INTO "public"."work" VALUES (10, '工作十', '這是工作十', '2019-05-25 17:18:15', '@工作', 'zip檔案', '陳博生', '李正彥', 't');

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."hint_hint_serno_seq"
OWNED BY "public"."hint"."hint_serno";
SELECT setval('"public"."hint_hint_serno_seq"', 10, true);
ALTER SEQUENCE "public"."list_list_serno_seq"
OWNED BY "public"."list"."list_serno";
SELECT setval('"public"."list_list_serno_seq"', 10, true);
ALTER SEQUENCE "public"."listwork_list_serno_seq"
OWNED BY "public"."listwork"."list_serno";
SELECT setval('"public"."listwork_list_serno_seq"', 1, false);
ALTER SEQUENCE "public"."listwork_listwork_serno_seq"
OWNED BY "public"."listwork"."listwork_serno";
SELECT setval('"public"."listwork_listwork_serno_seq"', 1, false);
ALTER SEQUENCE "public"."listwork_work_serno_seq"
OWNED BY "public"."listwork"."work_serno";
SELECT setval('"public"."listwork_work_serno_seq"', 1, false);
ALTER SEQUENCE "public"."project_projectpermission_serno_seq"
OWNED BY "public"."project"."projectpermission_serno";
SELECT setval('"public"."project_projectpermission_serno_seq"', 10, true);
ALTER SEQUENCE "public"."projectlist_list_serno_seq"
OWNED BY "public"."projectlist"."list_serno";
SELECT setval('"public"."projectlist_list_serno_seq"', 1, false);
ALTER SEQUENCE "public"."projectlist_projectlist_serno_seq"
OWNED BY "public"."projectlist"."projectlist_serno";
SELECT setval('"public"."projectlist_projectlist_serno_seq"', 1, false);
...
SELECT setval('"public"."projectpermission_projectpermission_serno_seq"', 10, true);
ALTER SEQUENCE "public"."teammember_teammember_serno_seq"
OWNED BY "public"."teammember"."teammember_serno";
SELECT setval('"public"."teammember_teammember_serno_seq"', 10, true);
ALTER SEQUENCE "public"."work_work_serno_seq"
OWNED BY "public"."work"."work_serno";
SELECT setval('"public"."work_work_serno_seq"', 10, true);

-- ----------------------------
-- Primary Key structure for table hint
-- ----------------------------
ALTER TABLE "public"."hint" ADD CONSTRAINT "hint_pkey" PRIMARY KEY ("hint_serno");
...
-- ----------------------------
ALTER TABLE "public"."hint" ADD CONSTRAINT "hint_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."project" ("project_id") ON DELETE RESTRICT ON UPDATE RESTRICT;
