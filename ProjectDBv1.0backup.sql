...
CREATE SEQUENCE "hint_hint_serno_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 2147483647
START 1
...
;
ALTER TABLE "hint" OWNER TO "blgwsyskuyxazi";
CREATE TABLE "list" (
...
INSERT INTO "public"."project" ("project_id","projectpermission_serno","project_password","project_name","project_startdate","project_enddate","project_hint") VALUES ('A001', 1, '001A', '專案一', '2019-01-26 15:12:17', '2019-02-05 18:47:17', 'f'),('B001', 2, '001A', '專案二', '2019-02-26 18:41:17', '2019-06-07 19:46:17', 't'),('C001', 3, '001A', '專案三', '2019-03-26 19:35:17', '2019-07-08 20:45:17', 'f'),('D001', 4, '001A', '專案四', '2019-04-26 21:18:17', '2019-08-09 07:44:17', 'f'),('E001', 5, '001A', '專案五', '2019-01-22 08:25:17', '2019-09-10 08:43:17', 'f'),('F001', 6, '001A', '專案六', '2019-01-28 19:55:17', '2019-10-11 10:42:17', 't'),('G001', 7, '001A', '專案七', '2019-01-29 15:15:17', '2019-11-12 15:41:17', 'f'),('H001', 8, '001A', '專案八', '2019-01-30 13:12:17', '2019-12-13 16:40:17', 't'),('I001', 9, '001A', '專案九', '2019-02-15 15:48:17', '2019-08-14 17:39:17', 'f'),('J001', 10, '001A', '專案十', '2019-03-21 17:38:17', '2019-07-15 18:38:17', 'f');
COMMIT;
BEGIN;
...
INSERT INTO "public"."work" ("work_serno","work_title","work_content","deadline","tag","file","first_principal","second_principal","work_hint") VALUES (1, '工作一', '這是工作一', '2019-05-25 17:18:15', '@工作', 'zip檔案', '王曉明', '張大陸', 't'),(2, '工作二', '這是工作二', '2019-05-25 17:18:15', '@工作', 'zip檔案', '測豐碩', '張辜陸', 'f'),(3, '工作三', '這是工作三', '2019-05-25 17:18:15', '@工作', 'zip檔案', '一條先', '德先', 'f'),(4, '工作四', '這是工作四', '2019-05-25 17:18:15', '@工作', 'zip檔案', '餔普忒', '特踢', 't'),(5, '工作五', '這是工作五', '2019-05-25 17:18:15', '@工作', 'zip檔案', '謀辜', '估三大', 'f'),(6, '工作六', '這是工作六', '2019-05-25 17:18:15', '@工作', 'zip檔案', '特蘇噴', '章三大', 't'),(7, '工作七', '這是工作七', '2019-05-25 17:18:15', '@工作', 'zip檔案', '辜三是', '一二心', 't'),(8, '工作八', '這是工作八', '2019-05-25 17:18:15', '@工作', 'zip檔案', '陳世強', '揚威祥', 'f'),(9, '工作九', '這是工作九', '2019-05-25 17:18:15', '@工作', 'zip檔案', '章德馨', '斯紅葉', 'f'),(10, '工作十', '這是工作十', '2019-05-25 17:18:15', '@工作', 'zip檔案', '陳博生', '李正彥', 't');
COMMIT;
ALTER TABLE "hint" ADD CONSTRAINT "hint_pkey" PRIMARY KEY ("hint_serno");
...
ALTER TABLE "hint" ADD CONSTRAINT "hint_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."project" ("project_id") ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER SEQUENCE "hint_hint_serno_seq"
OWNED BY "hint"."hint_serno";
SELECT setval('"hint_hint_serno_seq"', 11, true);
ALTER SEQUENCE "hint_hint_serno_seq" OWNER TO "blgwsyskuyxazi";
ALTER SEQUENCE "list_list_serno_seq"
OWNED BY "list"."list_serno";
SELECT setval('"list_list_serno_seq"', 11, true);
...
SELECT setval('"listwork_list_serno_seq"', 2, false);
...
SELECT setval('"listwork_listwork_serno_seq"', 2, false);
...
SELECT setval('"listwork_work_serno_seq"', 2, false);
...
SELECT setval('"project_projectpermission_serno_seq"', 11, true);
...
SELECT setval('"projectlist_list_serno_seq"', 2, false);
...
SELECT setval('"projectlist_projectlist_serno_seq"', 2, false);
...
SELECT setval('"projectpermission_projectpermission_serno_seq"', 11, true);
...
SELECT setval('"teammember_teammember_serno_seq"', 11, true);
...
SELECT setval('"work_work_serno_seq"', 11, true);
